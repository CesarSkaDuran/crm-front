...
const SECCIONES: ConfigSection[] = [
  {
    ...
    icon: 'business',
    items: [
      { title: 'Información legal (NIT, Razón Social)', link: '/configuracion/empresa', icon: 'store', ready: true },
      { title: 'Contacto (Teléfono, Email, Dirección)', link: '/configuracion/empresa', icon: 'contact_phone', ready: true },
      { title: 'Branding (Logo, Colores)', link: '/configuracion/empresa', icon: 'palette', ready: true },
      { title: 'Configuración fiscal (Régimen, Obligaciones)', link: '/configuracion/empresa', icon: 'gavel', ready: true },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Parámetros Generales (Moneda, País)', link: '/configuracion/empresa', icon: 'public', ready: true },
    ],
  },
  {
    title: 'Contabilidad',
